...
const gettingById = $('#get-id-attr')
console.log(gettingById.attr('id'))
...
const removeClass2Example = $('#remove-class-1');
removeClass2Example.removeClass('class-2');

const hideMe = $('#hide-me');
hideMe.hide();

const hidden = $('#show-me')
hidden.show()
